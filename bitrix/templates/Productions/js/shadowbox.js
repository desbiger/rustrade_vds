...
(function(window, undefined) {
    ...
    S.lang = {code:"en",of:"из",loading:"Загрузка",cancel:"Отмена",next:"Вперед",previous:"Назад",play:"Пуск",pause:"Пауза",close:"Закрыть",errors:{single:'You must install the <a href="{0}">{1}</a> browser plugin to view this content.',shared:'You must install both the <a href="{0}">{1}</a> and <a href="{2}">{3}</a> browser plugins to view this content.',either:'You must install either the <a href="{0}">{1}</a> or the <a href="{2}">{3}</a> browser plugin to view this content.'}};
